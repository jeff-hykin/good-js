...
const innerIterZipShortAsync = async function* (...iterables) {
 ...
 */
export const iterZipShortAsync = function(...iterables) {
    const generatorObject = innerIterZipShortAsync(...iterables)
